...
class _DoctorRegisterScreenState extends State<ExternalDoctorRegister> {
  ...
  Future<void> submitData() async {
    ...
    // Set the final values of specialty and department
    final finalSpecialty = _isCustomSpecialty ? _customSpecialty : speciality;
    final finalDepartment =
        _isCustomDepartment ? _customDepartment : department;
    ...
    try {
      final request = http.MultipartRequest(
        ...
        ..fields['speciality'] = finalSpecialty ?? ''
        ..fields['experience'] = experience
        ..fields['department'] = finalDepartment ?? ''
    ...
    return Column(
      ...
      children: [
        ...
        _buildDropdownField(
          ...
          validator: (value) {
            if (value == null && !_isCustomSpecialty) {
              return 'Please select a specialty';
            }
            if (_isCustomSpecialty && _customSpecialty.isEmpty) {
              return 'Please enter a custom specialty';
            }
            return null;
          },
          onChanged: (value) {
            setState(() {
              if (value == 'Other') {
                ...
                speciality =
                    null; // Important! Clear the value to avoid dropdown error
              } else {
                _isCustomSpecialty = false;
                speciality = value;
                _customSpecialty = ''; // Clear custom value
              }
            });
          },
        ),
            ...
            child: _buildTextField(
              ...
              onChanged: (value) {
                setState(() {
                  ...
                  // Don't set speciality directly anymore
                });
              },
            ),
          ),
        ...
        _buildDropdownField(
          ...
          validator: (value) {
            if (value == null && !_isCustomDepartment) {
              return 'Please select a department';
            }
            if (_isCustomDepartment && _customDepartment.isEmpty) {
              return 'Please enter a custom department';
            }
            return null;
          },
          onChanged: (value) {
            setState(() {
              if (value == 'Other') {
                ...
                _isCustomDepartment = false;
                department = value;
                _customDepartment = ''; // Clear custom value
              }
            });
          },
        ),
            ...
            child: _buildTextField(
              ...
              onChanged: (value) {
                setState(() {
                  ...
                  // Don't set department directly anymore
                });
              },
            ),
          ),
